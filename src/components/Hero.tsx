...
export default function Hero() {
  return (
    <section className="relative min-h-[80vh] bg-ivory md:bg-ivory flex items-stretch pt-20 pb-12 overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[55%_45%] w-full relative z-10">
        ...
        <div className="px-6 md:px-12 lg:px-20 py-12 md:py-16 flex flex-col justify-center border-r border-burgundy/5 order-2 md:order-1">
          ...
          >
            ...
            <span className="text-[10px] md:text-[11px] uppercase tracking-[0.4em] text-charcoal/80 font-normal">
              High-End Bridal & Editorial Artistry
            </span>

            <h1 className="mt-6 text-[42px] sm:text-[54px] md:text-[70px] lg:text-[80px] leading-[1] md:leading-[0.9] text-burgundy tracking-[-0.02em]">
              <span className="font-display italic font-normal">Professional makeup</span>
              <br />
              <span className="font-sans not-italic font-light text-[24px] sm:text-[32px] md:text-[40px] tracking-wide text-charcoal/80">by Priyasha Katariya</span>
            </h1>
        ...
        <div className="relative bg-transparent hidden md:flex flex-col items-center justify-center p-0 md:h-auto md:min-h-[80vh] order-1 md:order-2 w-full overflow-hidden">
